...
def main():
    ...
    parser.add_argument(
        "--model_dir", type=str, default="./verl/tools/pfam/ProTrek/weights/ProTrek_650M",
    ...
    # ---------- 加载 ProTrek 模型 ----------
    config = {
        "protein_config": f"{args.model_dir}/esm2_t33_650M_UR50D",
        "text_config": f"{args.model_dir}/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext",
        "structure_config": f"{args.model_dir}/foldseek_t30_150M",
        "from_checkpoint": f"{args.model_dir}/ProTrek_650M.pt",
    }
    device = args.device
